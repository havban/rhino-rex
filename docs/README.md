...
| --- | --- |
| [architecture.md](architecture.md) | Module map, the frame, rendering, how the pieces fit |
| [gameplay.md](gameplay.md) | Weapons, enemies, waves, scoring, destructible scenery |
...
generated in code. It runs as a static site on GitHub Pages. A Cloudflare
